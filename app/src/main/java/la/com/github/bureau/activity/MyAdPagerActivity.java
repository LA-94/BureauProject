...
import la.com.github.bureau.fragment.DetailedMyAdFragment;
import la.com.github.bureau.pojo.Ad;
import la.com.github.bureau.pojo.BulletinBoard;

public class MyAdPagerActivity extends AppCompatActivity {

    private static final String EXTRA_MY_AD_ID = "la.com.github.bureau.extra_my_ad_id";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UUID adId = (UUID) getIntent().getSerializableExtra(EXTRA_MY_AD_ID);
        init();
    ...
    private void init() {
        ...
        mViewPager.setAdapter(new FragmentPagerAdapter(fragmentManager) {
            ...
            public Fragment getItem(int i) {
                ...
                return DetailedMyAdFragment.newInstance(mAd.getId());
            }
    ...
    public static Intent getIntent(Context packageContext, UUID adId) {
        Intent intent = new Intent(packageContext, MyAdPagerActivity.class);
        intent.putExtra(EXTRA_MY_AD_ID, adId);
        return intent;
    }
